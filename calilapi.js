	...
	//		log("before: " + before_s + " and after: " + status + ":" + isup);
			if (isup){
				if (data.reserveurl != ""){
					...
					text += '<a href="'+data.reserveurl+'" target="_blank"><img border="0" src="https://calil.jp/public/img/gyazo/2064f557b8c17c879558165b0020ff5e.png"></a>';
					text += '</div>';
				}
				$("#"+isbn).html(text);
...
'<td></td>',
'<td style="background-color:#8888ff;width:50;">',
'<a href="北海道">北海道</a>',
'</td>',
'</tr>',
'',
...
'<tr style="height:25;">',
'<td></td><td></td><td></td><td style="width:30;"></td>',
'<td style="background-color:#99ddff;width:30;">',
'<a href="青森県">青森</a>',
'</td>',
...
'',
'<tr style="height:40;">',
'<td></td><td></td><td style="width:30;"></td>',
'<td style="background-color:#99ddff;width:30;">',
'<a href="秋田県">秋田</a>',
'</td>',
...
'',
'<tr style="height:25;">',
'<td style="background-color:#ccf577;width:30;">',
'<a href="石川県">石川</a>',
'</td>',
'<td style="background-color:#ccf577;width:30;">',
'<a href="富山県">富山</a>',
'</td>',
'<td style="background-color:#ccaaff;width:60;" colspan="2">',
'<a href="新潟県">新潟</a>',
'</td>',
'<td style="background-color:#99ddff;width:30;">',
'<a href="福島県">福島</a>',
...
'<tr style="height:25;">',
'<td style="background-color:#f5e577;width:26;">',
'<a href="長崎県">長崎</a>',
'</td>',
'<td style="background-color:#f5e577;width:26;">',
'<a href="佐賀県">佐賀</a>',
...
'<td style="background-color:#ff88bb;width:26;" rowspan="2">',
'<a href="山口県">山口</a>',
'</td>',
'<td style="background-color:#ff88bb;width:26;">',
'<a href="島根県">島根</a>',
'</td>',
'<td style="background-color:#ff88bb;width:26;">',
'<a href="鳥取県">鳥取</a>',
'</td>',
'<td style="background-color:#80f580;width:26;" rowspan="2">',
'<a href="兵庫県">兵庫</a>',
'</td>',
'<td style="background-color:#80f580;width:30;">',
'<a href="京都府">京都</a>',
'</td>',
'<td style="background-color:#80f580;width:26;">',
'<a href="滋賀県">滋賀</a>',
'</td>',
'<td style="background-color:#ccf577;width:30;">',
'<a href="福井県">福井</a>',
'</td>',
'<td style="background-color:#ccaaff;width:30;" rowspan="2">',
'<a href="長野県">長野</a>',
'</td>',
'<td style="background-color:#ff99ff;width:30;">',
'<a href="群馬県">群馬</a>',
'</td>',
'<td style="background-color:#ff99ff;width:30;">',
'<a href="栃木県">栃木</a>',
